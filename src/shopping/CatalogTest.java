...
public class CatalogTest {
    ...
    public void testAddProduct() {
        ...
        ProductFactory laptop = new ElectronicProductFactory("Laptop", 1200.0, "High-performance laptop", 10);
    ...
    public void testAddProducts() {
        ...
        ProductFactory tShirt = new ClothingProductFactory("T-Shirt", 25.0, "Comfortable cotton T-shirt", 50);
